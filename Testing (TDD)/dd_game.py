# To run doctest, type 'python -m doctest <file.py>'    
# If everything is ok, nothing returns
# Docstring for the game (on the top of the file)
'''Dungeon Game
Explore a dungeon to find a hidden door and scape. But be careful!
The grue is hidden somewhere inside!
...
# Não é necessário testar essa função do sistema
def clear():
    '''Clear the screen'''
...
def build_cells(width, height):
    '''Create and return a 'width' x 'height' of two-tuples 
...
def get_moves(player):
    '''Based on the tuple of the players position, return the list of
    acceptable moves
